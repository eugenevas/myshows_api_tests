...
def add_episodes():
    ...
    test_series = [
        {"id": 6, "name": "Наруто", "photo": "url1", "rating": 9, "status": "Смотрю","review": "Отличный сериал"},
        {"id": 7, "name": "Мандалорец", "photo": "url2", "rating": 9, "status": "Посмотрел", "review": "Эпично"},
        {"id": 8, "name": "Союз спасения. Время гнева", "photo": "url3", "rating": 8, "status": "Буду смотреть", "review": "Интересный сюжет"}
    ]
